...
Esta seção reúne materiais práticos para execução de análises, organização de ambientes computacionais, visualização de dados e aplicação de métodos utilizados em HCI/HCA.

Os tutoriais podem ser utilizados de forma independente ou como complemento aos módulos conceituais do curso.
