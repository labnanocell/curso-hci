...
<a href="tutorial_vscode_hci_hca.html" target="_blank" rel="noopener" class="md-button md-button--primary">
  Abrir o tutorial online
</a>

<a href="tutorial_vscode_hci_hca.pdf" target="_blank" rel="noopener" class="md-button md-button--primary">
  Baixar o PDF
</a>

!!! tip "Como acompanhar o tutorial"
    Recomendamos abrir o tutorial em HTML em uma aba do navegador e manter o VS Code aberto em outra janela.
